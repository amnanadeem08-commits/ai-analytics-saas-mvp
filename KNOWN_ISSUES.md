...
| KI-007 | Secrets | Production JWT fail-fast enforced; ops must supply ≥32-char secret | High (ops) | **Mitigated 2026-07-11** | App refuses production boot without strong `AUTH_JWT_SECRET`/`JWT_SECRET` |
